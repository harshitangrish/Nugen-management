                ...
                <div className="main-panel">
                    ...
                    <div className="content">
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                <Bigcard background="primary" number="COURSE DETAILS" heading="Add new course" icon="list" link="" />
                                <Bigcard background="danger" number="INSTALLMENT DETAILS" heading="Student details & Installments" icon="money" link="" />
                            </div>
                        </div>
